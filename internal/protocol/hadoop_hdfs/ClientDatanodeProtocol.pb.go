...
// *
// Drain lifecycle phase. NORMAL -> DRAINING -> DRAINED is the
// drain-initiated path; SHUTTING_DOWN is reached only via a separate
// shutdownDatanode call.
//
// Top-level (matches the Java-side scope) so the generated Go symbol is
// hdfs.DrainPhaseProto_*, mirroring the Java enum path.
type DrainPhaseProto int32

const (
	DrainPhaseProto_DRAIN_PHASE_NORMAL        DrainPhaseProto = 0
	DrainPhaseProto_DRAIN_PHASE_DRAINING      DrainPhaseProto = 1
	DrainPhaseProto_DRAIN_PHASE_DRAINED       DrainPhaseProto = 2
	DrainPhaseProto_DRAIN_PHASE_SHUTTING_DOWN DrainPhaseProto = 3
)

// Enum value maps for DrainPhaseProto.
var (
	DrainPhaseProto_name = map[int32]string{
		0: "DRAIN_PHASE_NORMAL",
		1: "DRAIN_PHASE_DRAINING",
		2: "DRAIN_PHASE_DRAINED",
		3: "DRAIN_PHASE_SHUTTING_DOWN",
	}
	DrainPhaseProto_value = map[string]int32{
		"DRAIN_PHASE_NORMAL":        0,
		"DRAIN_PHASE_DRAINING":      1,
		"DRAIN_PHASE_DRAINED":       2,
		"DRAIN_PHASE_SHUTTING_DOWN": 3,
	}
)

func (x DrainPhaseProto) Enum() *DrainPhaseProto {
	p := new(DrainPhaseProto)
	*p = x
	return p
}

func (x DrainPhaseProto) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (DrainPhaseProto) Descriptor() protoreflect.EnumDescriptor {
	return file_ClientDatanodeProtocol_proto_enumTypes[0].Descriptor()
}

func (DrainPhaseProto) Type() protoreflect.EnumType {
	return &file_ClientDatanodeProtocol_proto_enumTypes[0]
}

func (x DrainPhaseProto) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Do not use.
func (x *DrainPhaseProto) UnmarshalJSON(b []byte) error {
	num, err := protoimpl.X.UnmarshalJSONEnum(x.Descriptor(), b)
	if err != nil {
		return err
	}
	*x = DrainPhaseProto(num)
	return nil
}

// Deprecated: Use DrainPhaseProto.Descriptor instead.
func (DrainPhaseProto) EnumDescriptor() ([]byte, []int) {
...
// *
// drainAndSuspendDatanode (HOPSFS-345):
//
//	Drain the datanode and suspend it. Stops accepting new connections
//	(read and write), waits for pending async cloud uploads and IBR work
//	to settle, and leaves the DN in a suspended state where it no longer
//	serves client traffic. Returns when drain has completed or the
//	timeout has elapsed. Does NOT shut the datanode down; callers wanting
//	to terminate the DN after a successful drain must invoke
//	shutdownDatanode separately. The suspended state persists until the
//	DN process is restarted.
type DrainAndSuspendDatanodeRequestProto struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	TimeoutSecs *uint64 `protobuf:"varint,1,req,name=timeoutSecs" json:"timeoutSecs,omitempty"`
}

func (x *DrainAndSuspendDatanodeRequestProto) Reset() {
	*x = DrainAndSuspendDatanodeRequestProto{}
	if protoimpl.UnsafeEnabled {
...
func (x *DrainAndSuspendDatanodeRequestProto) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DrainAndSuspendDatanodeRequestProto) ProtoMessage() {}

func (x *DrainAndSuspendDatanodeRequestProto) ProtoReflect() protoreflect.Message {
	mi := &file_ClientDatanodeProtocol_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DrainAndSuspendDatanodeRequestProto.ProtoReflect.Descriptor instead.
func (*DrainAndSuspendDatanodeRequestProto) Descriptor() ([]byte, []int) {
	return file_ClientDatanodeProtocol_proto_rawDescGZIP(), []int{10}
}

func (x *DrainAndSuspendDatanodeRequestProto) GetTimeoutSecs() uint64 {
...
type DrainAndSuspendDatanodeResponseProto struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Status *DrainStatusProto `protobuf:"bytes,1,req,name=status" json:"status,omitempty"`
}

func (x *DrainAndSuspendDatanodeResponseProto) Reset() {
	*x = DrainAndSuspendDatanodeResponseProto{}
	if protoimpl.UnsafeEnabled {
...
func (x *DrainAndSuspendDatanodeResponseProto) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DrainAndSuspendDatanodeResponseProto) ProtoMessage() {}

func (x *DrainAndSuspendDatanodeResponseProto) ProtoReflect() protoreflect.Message {
	mi := &file_ClientDatanodeProtocol_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DrainAndSuspendDatanodeResponseProto.ProtoReflect.Descriptor instead.
func (*DrainAndSuspendDatanodeResponseProto) Descriptor() ([]byte, []int) {
	return file_ClientDatanodeProtocol_proto_rawDescGZIP(), []int{11}
}

func (x *DrainAndSuspendDatanodeResponseProto) GetStatus() *DrainStatusProto {
	if x != nil {
		return x.Status
	}
	return nil
...
// *
// Locally-available datanode drain status. All counter fields are
// optional with default=0 to match the Java DN serializer; the DN may
// omit zero-valued fields on the wire, so the client must accept their
// absence rather than rejecting the message.
type DrainStatusProto struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Phase                                 *DrainPhaseProto `protobuf:"varint,1,req,name=phase,enum=hadoop.hdfs.DrainPhaseProto" json:"phase,omitempty"`
	DrainSucceeded                        *bool            `protobuf:"varint,2,opt,name=drainSucceeded,def=0" json:"drainSucceeded,omitempty"`
	WritePipelinesActive                  *uint32          `protobuf:"varint,3,opt,name=writePipelinesActive,def=0" json:"writePipelinesActive,omitempty"`
	UploadsOutstanding                    *uint32          `protobuf:"varint,4,opt,name=uploadsOutstanding,def=0" json:"uploadsOutstanding,omitempty"`
	UploadQueueDepth                      *uint32          `protobuf:"varint,5,opt,name=uploadQueueDepth,def=0" json:"uploadQueueDepth,omitempty"`
	UploadActive                          *uint32          `protobuf:"varint,6,opt,name=uploadActive,def=0" json:"uploadActive,omitempty"`
	IbrPending                            *uint32          `protobuf:"varint,7,opt,name=ibrPending,def=0" json:"ibrPending,omitempty"`
	IbrSendsInFlight                      *uint32          `protobuf:"varint,8,opt,name=ibrSendsInFlight,def=0" json:"ibrSendsInFlight,omitempty"`
	InterruptedUploadCount                *uint32          `protobuf:"varint,9,opt,name=interruptedUploadCount,def=0" json:"interruptedUploadCount,omitempty"`
	InterruptedUploadCountSinceDrainStart *uint32          `protobuf:"varint,10,opt,name=interruptedUploadCountSinceDrainStart,def=0" json:"interruptedUploadCountSinceDrainStart,omitempty"`
	MillisRemaining                       *uint64          `protobuf:"varint,11,opt,name=millisRemaining,def=0" json:"millisRemaining,omitempty"`
}

// Default values for DrainStatusProto fields.
const (
	Default_DrainStatusProto_DrainSucceeded                        = bool(false)
	Default_DrainStatusProto_WritePipelinesActive                  = uint32(0)
	Default_DrainStatusProto_UploadsOutstanding                    = uint32(0)
	Default_DrainStatusProto_UploadQueueDepth                      = uint32(0)
	Default_DrainStatusProto_UploadActive                          = uint32(0)
	Default_DrainStatusProto_IbrPending                            = uint32(0)
	Default_DrainStatusProto_IbrSendsInFlight                      = uint32(0)
	Default_DrainStatusProto_InterruptedUploadCount                = uint32(0)
	Default_DrainStatusProto_InterruptedUploadCountSinceDrainStart = uint32(0)
	Default_DrainStatusProto_MillisRemaining                       = uint64(0)
)

func (x *DrainStatusProto) Reset() {
	*x = DrainStatusProto{}
	if protoimpl.UnsafeEnabled {
...
func (x *DrainStatusProto) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DrainStatusProto) ProtoMessage() {}

func (x *DrainStatusProto) ProtoReflect() protoreflect.Message {
	mi := &file_ClientDatanodeProtocol_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DrainStatusProto.ProtoReflect.Descriptor instead.
func (*DrainStatusProto) Descriptor() ([]byte, []int) {
	return file_ClientDatanodeProtocol_proto_rawDescGZIP(), []int{12}
}

func (x *DrainStatusProto) GetPhase() DrainPhaseProto {
	if x != nil && x.Phase != nil {
		return *x.Phase
	}
	return DrainPhaseProto_DRAIN_PHASE_NORMAL
}

func (x *DrainStatusProto) GetDrainSucceeded() bool {
	if x != nil && x.DrainSucceeded != nil {
		return *x.DrainSucceeded
	}
	return Default_DrainStatusProto_DrainSucceeded
}

func (x *DrainStatusProto) GetWritePipelinesActive() uint32 {
	if x != nil && x.WritePipelinesActive != nil {
		return *x.WritePipelinesActive
	}
	return Default_DrainStatusProto_WritePipelinesActive
}

func (x *DrainStatusProto) GetUploadsOutstanding() uint32 {
	if x != nil && x.UploadsOutstanding != nil {
		return *x.UploadsOutstanding
	}
	return Default_DrainStatusProto_UploadsOutstanding
}

func (x *DrainStatusProto) GetUploadQueueDepth() uint32 {
	if x != nil && x.UploadQueueDepth != nil {
		return *x.UploadQueueDepth
	}
	return Default_DrainStatusProto_UploadQueueDepth
}

func (x *DrainStatusProto) GetUploadActive() uint32 {
	if x != nil && x.UploadActive != nil {
		return *x.UploadActive
	}
	return Default_DrainStatusProto_UploadActive
}

func (x *DrainStatusProto) GetIbrPending() uint32 {
	if x != nil && x.IbrPending != nil {
		return *x.IbrPending
	}
	return Default_DrainStatusProto_IbrPending
}

func (x *DrainStatusProto) GetIbrSendsInFlight() uint32 {
	if x != nil && x.IbrSendsInFlight != nil {
		return *x.IbrSendsInFlight
	}
	return Default_DrainStatusProto_IbrSendsInFlight
}

func (x *DrainStatusProto) GetInterruptedUploadCount() uint32 {
	if x != nil && x.InterruptedUploadCount != nil {
		return *x.InterruptedUploadCount
	}
	return Default_DrainStatusProto_InterruptedUploadCount
}

func (x *DrainStatusProto) GetInterruptedUploadCountSinceDrainStart() uint32 {
	if x != nil && x.InterruptedUploadCountSinceDrainStart != nil {
		return *x.InterruptedUploadCountSinceDrainStart
	}
	return Default_DrainStatusProto_InterruptedUploadCountSinceDrainStart
}

func (x *DrainStatusProto) GetMillisRemaining() uint64 {
	if x != nil && x.MillisRemaining != nil {
		return *x.MillisRemaining
	}
	return Default_DrainStatusProto_MillisRemaining
}
...
func (x *QueryPlanStatusResponseProto) Reset() {
	*x = QueryPlanStatusResponseProto{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ClientDatanodeProtocol_proto_msgTypes[28]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*QueryPlanStatusResponseProto) Descriptor() ([]byte, []int) {
	return file_ClientDatanodeProtocol_proto_rawDescGZIP(), []int{28}
}
...
func (x *DiskBalancerSettingRequestProto) Reset() {
	*x = DiskBalancerSettingRequestProto{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ClientDatanodeProtocol_proto_msgTypes[29]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DiskBalancerSettingRequestProto) Descriptor() ([]byte, []int) {
	return file_ClientDatanodeProtocol_proto_rawDescGZIP(), []int{29}
}
...
func (x *DiskBalancerSettingResponseProto) Reset() {
	*x = DiskBalancerSettingResponseProto{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ClientDatanodeProtocol_proto_msgTypes[30]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DiskBalancerSettingResponseProto) Descriptor() ([]byte, []int) {
	return file_ClientDatanodeProtocol_proto_rawDescGZIP(), []int{30}
}
...
var file_ClientDatanodeProtocol_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_ClientDatanodeProtocol_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_ClientDatanodeProtocol_proto_msgTypes = make([]protoimpl.MessageInfo, 31)
var file_ClientDatanodeProtocol_proto_goTypes = []interface{}{
	(DrainPhaseProto)(0),                              // 0: hadoop.hdfs.DrainPhaseProto
	(*GetReplicaVisibleLengthRequestProto)(nil),       // 1: hadoop.hdfs.GetReplicaVisibleLengthRequestProto
	(*GetReplicaVisibleLengthResponseProto)(nil),      // 2: hadoop.hdfs.GetReplicaVisibleLengthResponseProto
	(*RefreshNamenodesRequestProto)(nil),              // 3: hadoop.hdfs.RefreshNamenodesRequestProto
	(*RefreshNamenodesResponseProto)(nil),             // 4: hadoop.hdfs.RefreshNamenodesResponseProto
	(*DeleteBlockPoolRequestProto)(nil),               // 5: hadoop.hdfs.DeleteBlockPoolRequestProto
	(*DeleteBlockPoolResponseProto)(nil),              // 6: hadoop.hdfs.DeleteBlockPoolResponseProto
	(*GetBlockLocalPathInfoRequestProto)(nil),         // 7: hadoop.hdfs.GetBlockLocalPathInfoRequestProto
	(*GetBlockLocalPathInfoResponseProto)(nil),        // 8: hadoop.hdfs.GetBlockLocalPathInfoResponseProto
	(*ShutdownDatanodeRequestProto)(nil),              // 9: hadoop.hdfs.ShutdownDatanodeRequestProto
	(*ShutdownDatanodeResponseProto)(nil),             // 10: hadoop.hdfs.ShutdownDatanodeResponseProto
	(*DrainAndSuspendDatanodeRequestProto)(nil),       // 11: hadoop.hdfs.DrainAndSuspendDatanodeRequestProto
	(*DrainAndSuspendDatanodeResponseProto)(nil),      // 12: hadoop.hdfs.DrainAndSuspendDatanodeResponseProto
	(*DrainStatusProto)(nil),                          // 13: hadoop.hdfs.DrainStatusProto
	(*EvictWritersRequestProto)(nil),                  // 14: hadoop.hdfs.EvictWritersRequestProto
	(*EvictWritersResponseProto)(nil),                 // 15: hadoop.hdfs.EvictWritersResponseProto
	(*GetDatanodeInfoRequestProto)(nil),               // 16: hadoop.hdfs.GetDatanodeInfoRequestProto
	(*GetDatanodeInfoResponseProto)(nil),              // 17: hadoop.hdfs.GetDatanodeInfoResponseProto
	(*GetVolumeReportRequestProto)(nil),               // 18: hadoop.hdfs.GetVolumeReportRequestProto
	(*GetVolumeReportResponseProto)(nil),              // 19: hadoop.hdfs.GetVolumeReportResponseProto
	(*TriggerBlockReportRequestProto)(nil),            // 20: hadoop.hdfs.TriggerBlockReportRequestProto
	(*TriggerBlockReportResponseProto)(nil),           // 21: hadoop.hdfs.TriggerBlockReportResponseProto
	(*GetBalancerBandwidthRequestProto)(nil),          // 22: hadoop.hdfs.GetBalancerBandwidthRequestProto
	(*GetBalancerBandwidthResponseProto)(nil),         // 23: hadoop.hdfs.GetBalancerBandwidthResponseProto
	(*SubmitDiskBalancerPlanRequestProto)(nil),        // 24: hadoop.hdfs.SubmitDiskBalancerPlanRequestProto
	(*SubmitDiskBalancerPlanResponseProto)(nil),       // 25: hadoop.hdfs.SubmitDiskBalancerPlanResponseProto
	(*CancelPlanRequestProto)(nil),                    // 26: hadoop.hdfs.CancelPlanRequestProto
	(*CancelPlanResponseProto)(nil),                   // 27: hadoop.hdfs.CancelPlanResponseProto
	(*QueryPlanStatusRequestProto)(nil),               // 28: hadoop.hdfs.QueryPlanStatusRequestProto
	(*QueryPlanStatusResponseProto)(nil),              // 29: hadoop.hdfs.QueryPlanStatusResponseProto
	(*DiskBalancerSettingRequestProto)(nil),           // 30: hadoop.hdfs.DiskBalancerSettingRequestProto
	(*DiskBalancerSettingResponseProto)(nil),          // 31: hadoop.hdfs.DiskBalancerSettingResponseProto
	(*ExtendedBlockProto)(nil),                        // 32: hadoop.hdfs.ExtendedBlockProto
	(*hadoop_common.TokenProto)(nil),                  // 33: hadoop.common.TokenProto
	(*DatanodeLocalInfoProto)(nil),                    // 34: hadoop.hdfs.DatanodeLocalInfoProto
	(*DatanodeVolumeInfoProto)(nil),                   // 35: hadoop.hdfs.DatanodeVolumeInfoProto
	(*GetReconfigurationStatusRequestProto)(nil),      // 36: hadoop.hdfs.GetReconfigurationStatusRequestProto
	(*StartReconfigurationRequestProto)(nil),          // 37: hadoop.hdfs.StartReconfigurationRequestProto
	(*ListReconfigurablePropertiesRequestProto)(nil),  // 38: hadoop.hdfs.ListReconfigurablePropertiesRequestProto
	(*GetReconfigurationStatusResponseProto)(nil),     // 39: hadoop.hdfs.GetReconfigurationStatusResponseProto
	(*StartReconfigurationResponseProto)(nil),         // 40: hadoop.hdfs.StartReconfigurationResponseProto
	(*ListReconfigurablePropertiesResponseProto)(nil), // 41: hadoop.hdfs.ListReconfigurablePropertiesResponseProto
}
var file_ClientDatanodeProtocol_proto_depIdxs = []int32{
	32, // 0: hadoop.hdfs.GetReplicaVisibleLengthRequestProto.block:type_name -> hadoop.hdfs.ExtendedBlockProto
	32, // 1: hadoop.hdfs.GetBlockLocalPathInfoRequestProto.block:type_name -> hadoop.hdfs.ExtendedBlockProto
	33, // 2: hadoop.hdfs.GetBlockLocalPathInfoRequestProto.token:type_name -> hadoop.common.TokenProto
	32, // 3: hadoop.hdfs.GetBlockLocalPathInfoResponseProto.block:type_name -> hadoop.hdfs.ExtendedBlockProto
	13, // 4: hadoop.hdfs.DrainAndSuspendDatanodeResponseProto.status:type_name -> hadoop.hdfs.DrainStatusProto
	0,  // 5: hadoop.hdfs.DrainStatusProto.phase:type_name -> hadoop.hdfs.DrainPhaseProto
	34, // 6: hadoop.hdfs.GetDatanodeInfoResponseProto.localInfo:type_name -> hadoop.hdfs.DatanodeLocalInfoProto
	35, // 7: hadoop.hdfs.GetVolumeReportResponseProto.volumeInfo:type_name -> hadoop.hdfs.DatanodeVolumeInfoProto
	1,  // 8: hadoop.hdfs.ClientDatanodeProtocolService.getReplicaVisibleLength:input_type -> hadoop.hdfs.GetReplicaVisibleLengthRequestProto
	3,  // 9: hadoop.hdfs.ClientDatanodeProtocolService.refreshNamenodes:input_type -> hadoop.hdfs.RefreshNamenodesRequestProto
	5,  // 10: hadoop.hdfs.ClientDatanodeProtocolService.deleteBlockPool:input_type -> hadoop.hdfs.DeleteBlockPoolRequestProto
	7,  // 11: hadoop.hdfs.ClientDatanodeProtocolService.getBlockLocalPathInfo:input_type -> hadoop.hdfs.GetBlockLocalPathInfoRequestProto
	9,  // 12: hadoop.hdfs.ClientDatanodeProtocolService.shutdownDatanode:input_type -> hadoop.hdfs.ShutdownDatanodeRequestProto
	11, // 13: hadoop.hdfs.ClientDatanodeProtocolService.drainAndSuspendDatanode:input_type -> hadoop.hdfs.DrainAndSuspendDatanodeRequestProto
	14, // 14: hadoop.hdfs.ClientDatanodeProtocolService.evictWriters:input_type -> hadoop.hdfs.EvictWritersRequestProto
	16, // 15: hadoop.hdfs.ClientDatanodeProtocolService.getDatanodeInfo:input_type -> hadoop.hdfs.GetDatanodeInfoRequestProto
	18, // 16: hadoop.hdfs.ClientDatanodeProtocolService.getVolumeReport:input_type -> hadoop.hdfs.GetVolumeReportRequestProto
	36, // 17: hadoop.hdfs.ClientDatanodeProtocolService.getReconfigurationStatus:input_type -> hadoop.hdfs.GetReconfigurationStatusRequestProto
	37, // 18: hadoop.hdfs.ClientDatanodeProtocolService.startReconfiguration:input_type -> hadoop.hdfs.StartReconfigurationRequestProto
	38, // 19: hadoop.hdfs.ClientDatanodeProtocolService.listReconfigurableProperties:input_type -> hadoop.hdfs.ListReconfigurablePropertiesRequestProto
	20, // 20: hadoop.hdfs.ClientDatanodeProtocolService.triggerBlockReport:input_type -> hadoop.hdfs.TriggerBlockReportRequestProto
	22, // 21: hadoop.hdfs.ClientDatanodeProtocolService.getBalancerBandwidth:input_type -> hadoop.hdfs.GetBalancerBandwidthRequestProto
	24, // 22: hadoop.hdfs.ClientDatanodeProtocolService.submitDiskBalancerPlan:input_type -> hadoop.hdfs.SubmitDiskBalancerPlanRequestProto
	26, // 23: hadoop.hdfs.ClientDatanodeProtocolService.cancelDiskBalancerPlan:input_type -> hadoop.hdfs.CancelPlanRequestProto
	28, // 24: hadoop.hdfs.ClientDatanodeProtocolService.queryDiskBalancerPlan:input_type -> hadoop.hdfs.QueryPlanStatusRequestProto
	30, // 25: hadoop.hdfs.ClientDatanodeProtocolService.getDiskBalancerSetting:input_type -> hadoop.hdfs.DiskBalancerSettingRequestProto
	2,  // 26: hadoop.hdfs.ClientDatanodeProtocolService.getReplicaVisibleLength:output_type -> hadoop.hdfs.GetReplicaVisibleLengthResponseProto
	4,  // 27: hadoop.hdfs.ClientDatanodeProtocolService.refreshNamenodes:output_type -> hadoop.hdfs.RefreshNamenodesResponseProto
	6,  // 28: hadoop.hdfs.ClientDatanodeProtocolService.deleteBlockPool:output_type -> hadoop.hdfs.DeleteBlockPoolResponseProto
	8,  // 29: hadoop.hdfs.ClientDatanodeProtocolService.getBlockLocalPathInfo:output_type -> hadoop.hdfs.GetBlockLocalPathInfoResponseProto
	10, // 30: hadoop.hdfs.ClientDatanodeProtocolService.shutdownDatanode:output_type -> hadoop.hdfs.ShutdownDatanodeResponseProto
	12, // 31: hadoop.hdfs.ClientDatanodeProtocolService.drainAndSuspendDatanode:output_type -> hadoop.hdfs.DrainAndSuspendDatanodeResponseProto
	15, // 32: hadoop.hdfs.ClientDatanodeProtocolService.evictWriters:output_type -> hadoop.hdfs.EvictWritersResponseProto
	17, // 33: hadoop.hdfs.ClientDatanodeProtocolService.getDatanodeInfo:output_type -> hadoop.hdfs.GetDatanodeInfoResponseProto
	19, // 34: hadoop.hdfs.ClientDatanodeProtocolService.getVolumeReport:output_type -> hadoop.hdfs.GetVolumeReportResponseProto
	39, // 35: hadoop.hdfs.ClientDatanodeProtocolService.getReconfigurationStatus:output_type -> hadoop.hdfs.GetReconfigurationStatusResponseProto
	40, // 36: hadoop.hdfs.ClientDatanodeProtocolService.startReconfiguration:output_type -> hadoop.hdfs.StartReconfigurationResponseProto
	41, // 37: hadoop.hdfs.ClientDatanodeProtocolService.listReconfigurableProperties:output_type -> hadoop.hdfs.ListReconfigurablePropertiesResponseProto
	21, // 38: hadoop.hdfs.ClientDatanodeProtocolService.triggerBlockReport:output_type -> hadoop.hdfs.TriggerBlockReportResponseProto
	23, // 39: hadoop.hdfs.ClientDatanodeProtocolService.getBalancerBandwidth:output_type -> hadoop.hdfs.GetBalancerBandwidthResponseProto
	25, // 40: hadoop.hdfs.ClientDatanodeProtocolService.submitDiskBalancerPlan:output_type -> hadoop.hdfs.SubmitDiskBalancerPlanResponseProto
	27, // 41: hadoop.hdfs.ClientDatanodeProtocolService.cancelDiskBalancerPlan:output_type -> hadoop.hdfs.CancelPlanResponseProto
	29, // 42: hadoop.hdfs.ClientDatanodeProtocolService.queryDiskBalancerPlan:output_type -> hadoop.hdfs.QueryPlanStatusResponseProto
	31, // 43: hadoop.hdfs.ClientDatanodeProtocolService.getDiskBalancerSetting:output_type -> hadoop.hdfs.DiskBalancerSettingResponseProto
...
func file_ClientDatanodeProtocol_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_ClientDatanodeProtocol_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DrainAndSuspendDatanodeRequestProto); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_ClientDatanodeProtocol_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DrainAndSuspendDatanodeResponseProto); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_ClientDatanodeProtocol_proto_msgTypes[28].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ClientDatanodeProtocol_proto_msgTypes[29].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ClientDatanodeProtocol_proto_msgTypes[30].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_ClientDatanodeProtocol_proto_enumTypes,
